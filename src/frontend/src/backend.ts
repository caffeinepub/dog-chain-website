...
import type { ExternalBlob as _ExternalBlob, Feature as _Feature, HeroContent as _HeroContent, Product as _Product, Testimonial as _Testimonial, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createFeature(arg0: Feature): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createFeature(await to_candid_Feature_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTestimonial(arg0: Testimonial): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createTestimonial(await to_candid_Testimonial_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeatures(): Promise<Array<Feature>> {
        if (this.processError) {
            try {
    ...
    async updateFeature(arg0: bigint, arg1: Feature): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFeature(arg0, await to_candid_Feature_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHeroContent(arg0: HeroContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateHeroContent(await to_candid_HeroContent_n33(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, await to_candid_Product_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTestimonial(arg0: bigint, arg1: Testimonial): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTestimonial(arg0, await to_candid_Testimonial_n15(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Feature_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Feature): Promise<Feature> {
    return await from_candid_record_n26(_uploadFile, _downloadFile, value);
}
async function from_candid_HeroContent_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _HeroContent): Promise<HeroContent> {
...
async function from_candid_Testimonial_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Testimonial): Promise<Testimonial> {
...
async function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_HeroContent]): Promise<HeroContent | null> {
    return value.length === 0 ? null : await from_candid_HeroContent_n28(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        backgroundImage: await from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.backgroundImage),
...
async function from_candid_record_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        authorAvatar: await from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.authorAvatar),
        createdAt: value.createdAt,
...
async function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Feature>): Promise<Array<Feature>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Feature_n25(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Testimonial>): Promise<Array<Testimonial>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Testimonial_n31(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Feature_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Feature): Promise<_Feature> {
    return await to_candid_record_n11(_uploadFile, _downloadFile, value);
}
async function to_candid_HeroContent_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: HeroContent): Promise<_HeroContent> {
...
async function to_candid_Testimonial_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Testimonial): Promise<_Testimonial> {
...
async function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        authorAvatar: await to_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.authorAvatar),
        createdAt: value.createdAt,
        authorName: value.authorName,
        quote: value.quote,
        rating: value.rating
...
async function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        headline: value.headline,
        backgroundImage: await to_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.backgroundImage),
        ctaLink: value.ctaLink,
        ctaText: value.ctaText,
        subheadline: value.subheadline
    };
